...
export default function ScrKac011() {
  const [changeType, setChangeType] = useState<"rent" | "customer">("rent");

  return (
    <div className="space-y-4">
      <div className="border-b border-[#e7eef5] pb-3">
        <div className="text-[11px] font-semibold uppercase tracking-wider text-[#94a3b8]">계약처리</div>
        <h1 className="mt-0.5 text-[18px] font-bold text-[#0f172a]">[RT] 계약변경처리</h1>
      </div>
        ...
        <div className="px-5 py-4">
          <table className="text-sm border-collapse">
            <tbody>
              ...
              <tr className="border-b border-[#f1f5f9]">
                <td className="py-2.5 pr-4 text-[12px] font-semibold text-[#64748b]">년도</td>
                <td className="py-2.5">
              ...
              <tr className="border-b border-[#f1f5f9]">
                <td className="py-2.5 pr-4 text-[12px] font-semibold text-[#64748b]">수시고지일자</td>
                <td className="py-2.5">
                  <Input className="h-7 w-32 border-[#d6e0ea] text-sm" />
                </td>
              </tr>
              <tr className="border-b border-[#f1f5f9]">
                <td className="py-2.5 pr-4 text-[12px] font-semibold text-[#64748b]">최근 수시 고지일(연고지)</td>
                <td className="py-2.5">
                  <Input className="h-7 w-32 border-[#d6e0ea] text-sm" />
                </td>
              </tr>
                ...
                <td className="py-2.5">
                  <label className="flex items-center gap-2 cursor-pointer text-[12px] text-[#334155]">
                    <input
                      ...
                      name="changeType"
                      value="rent"
                      checked={changeType === "rent"}
                      onChange={() => setChangeType("rent")}
                ...
                <td className="py-2.5">
                  <label className="flex items-center gap-2 cursor-pointer text-[12px] text-[#334155]">
                    <input
                      ...
                      name="changeType"
                      value="customer"
                      checked={changeType === "customer"}
                      onChange={() => setChangeType("customer")}
                      className="accent-[#002D56]"
                    />
                    고객코드의 변경
                  </label>
