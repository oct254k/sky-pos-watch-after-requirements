...
export default function ScrKac010() {
  return (
    <div className="space-y-4">
      <div className="border-b border-[#e7eef5] pb-3">
        ...
        <h1 className="mt-0.5 text-[18px] font-bold text-[#0f172a]">[RT] 계약 중도해지 처리(일부 임대물건)</h1>
      </div>
        ...
        <div className="px-5 py-4">
          <table className="text-sm border-collapse">
            <tbody>
              ...
              <tr className="border-b border-[#f1f5f9]">
                <td className="py-2.5 pr-4 text-[12px] font-semibold text-[#64748b]">환급요청일자</td>
                <td className="py-2.5">
