...
export default function ScrKac015() {
  return (
    <div className="space-y-4">
      <div className="border-b border-[#e7eef5] pb-3">
        ...
        <h1 className="mt-0.5 text-[18px] font-bold text-[#0f172a]">[RT] 매출액 기준 추가임대료 산정 및 전송</h1>
      </div>
        ...
        <div className="px-5 py-4">
          <table className="text-sm border-collapse">
            <tbody>
              ...
              <tr className="border-b border-[#f1f5f9]">
                <td className="py-2.5 pr-4 text-[12px] font-semibold text-[#64748b]">추가임대료 산출년도</td>
                <td className="py-2.5">
