...
export default function ScrKac008() {
  return (
    <div className="space-y-4">
      <div className="border-b border-[#e7eef5] pb-3">
        ...
        <h1 className="mt-0.5 text-[18px] font-bold text-[#0f172a]">[RT] 계약만료 처리</h1>
      </div>
          ...
          <table className="text-sm border-collapse">
            <tbody>
              ...
              <tr className="border-b border-[#f1f5f9]">
                ...
                <td className="py-2.5">
                  <Input defaultValue="27955" className="h-7 w-28 border-[#d6e0ea] text-sm" />
                </td>
              </tr>
              <tr className="border-b border-[#f1f5f9]">
                <td className="py-2.5 pr-4 text-[12px] font-semibold text-[#64748b]">임대보증금 환급요청일자</td>
                <td className="py-2.5">
                  <Input defaultValue="2026.06.14" className="h-7 w-32 border-[#d6e0ea] text-sm" />
                </td>
              </tr>
              <tr>
                <td className="py-2.5 pr-4 text-[12px] font-semibold text-[#64748b]">결재요청사번</td>
                <td className="py-2.5">
                  <Input defaultValue="14860" className="h-7 w-28 border-[#d6e0ea] text-sm" />
                </td>
              </tr>
            </tbody>
          </table>
